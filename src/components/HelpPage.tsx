          ...
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 space-y-4">
            ...
            <div>
              ...
              <ul className="text-sm text-slate-300 space-y-1 list-disc list-inside">
                ...
                <li>
                  <strong className="text-white">赛后弃赛（针对选手个人）</strong>：在右侧控制面板「赛前 / 赛后弃赛管理」区域，点击选手旁的「赛后弃赛」按钮手动标记退赛。<strong className="text-amber-300">不产生新的胜负归属给他人</strong>（与赛前弃赛不同——赛前弃赛会给对方一个胜场）；后续轮次不再参与配对；已完赛场次全部保留，冻结在弃赛时刻的个人战绩中，对手胜率仍按聚合公式计算（胜场和/总场次和），弃赛选手因场次少自动降权。
                </li>
              </ul>
            </div>
          </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <FAQItem
              ...
              answer="分两种入口，两者<strong>都等同于退赛</strong>（后续不再安排对阵），但触发方式与胜负归属不同：① 赛前弃赛（针对某场具体对阵）：对阵卡片展开后选择「赛前弃·右弃权·左胜」或「赛前弃·左弃权·右胜」。胜方记个人胜场，弃赛方不记个人败场，该场整体不计入对手胜率网络，弃赛者本人自动进入退赛状态。② 赛后弃赛（针对选手个人）：在右侧控制面板的「赛前 / 赛后弃赛管理」区域，点击选手旁的「赛后弃赛」按钮手动标记。不产生新的胜负归属给他人，仅标记选手从下一轮起退出，已完赛场次按真实结果正常计入对手胜率网络；如需恢复，可在「已赛前弃赛」列表中点击「恢复」按钮。单败淘汰中比赛败者会被自动标记为「淘汰」，与手动弃赛是两种不同状态：淘汰选手在排行榜显示灰色「淘汰」标签，仍保留在排行榜中；弃赛选手显示红色「弃赛」标签并加删除线，排在最后。"
            />
            <FAQItem
