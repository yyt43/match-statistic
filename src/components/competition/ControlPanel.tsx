...
export function ControlPanel({
  ...
  return (
    <div className="h-full flex flex-col bg-slate-800/40 border border-slate-700/40 rounded-2xl overflow-hidden">
      ...
      <div className={`grid border-b border-slate-700/50 bg-slate-800/40 ${
        setupLayout
          ? 'grid-cols-[260px_300px_minmax(460px,1fr)]'
          : isSetup
            ? 'grid-cols-3'
            : 'grid-cols-1'
      }`}>
      ...
      <div className={setupLayout ? 'grid min-h-0 flex-1 grid-cols-[260px_minmax(0,1fr)]' : 'contents'}>
      {showGroupManager && (
        <div className={setupLayout
          ? 'min-h-0 overflow-y-auto border-r border-slate-700/50 p-4'
      ...
      <div
        ...
        className={setupLayout
          ? 'col-start-2 grid min-h-0 grid-cols-[300px_minmax(460px,1fr)] gap-4 overflow-hidden p-4'
          : 'flex-1 overflow-y-auto p-4 space-y-4'}
      >
        {/* 赛制管理 */}
        {isSetup && (
          <div className={setupLayout
            ? 'col-start-1 min-h-0 overflow-y-auto pr-1'
            : 'space-y-3'}
          >
            {showFormatManager && (
        ...
        {isSetup && (
          <div className={setupLayout
            ? 'col-start-2 min-h-0 overflow-y-auto pr-1'
            : ''}
          >
