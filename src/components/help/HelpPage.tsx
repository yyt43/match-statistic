...
const content: Record<AppLanguage, HelpCopy> = {
  zh: {
    ...
    featureItems: [
      ...
      { icon: <Keyboard className="w-5 h-5" />, title: '快速录分', description: '集中处理当前轮剩余比赛，支持 1 / 2 / D 快捷键和自动跳转。' },
  ...
  en: {
    ...
    featureItems: [
      ...
      { icon: <Keyboard className="w-5 h-5" />, title: 'Quick score entry', description: 'Process remaining current-round matches with 1 / 2 / D shortcuts and auto-advance.' },
