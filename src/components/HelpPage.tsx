          ...
          <div className="bg-slate-800/50 border border-slate-700/50 rounded-xl p-6 space-y-4">
            <div>
              ...
              <div className="text-sm text-slate-300 space-y-3">
                ...
                <RuleItem num="8" title="轮空计分">
                  轮空选手该轮得分为 2-0（BO1=1-0，BO3=2-0，BO5=3-0，BO7=4-0），该场次有效并计入局胜率、对手胜率等所有小分统计。轮空对手视为一个 0 胜率虚拟对手，会轻微拉低轮空者的对手胜率。
                </RuleItem>
            ...
            <div>
              ...
              <ul className="text-sm text-slate-300 space-y-1 list-disc list-inside">
                ...
                <li>轮空场次有效：比分按赛制自动填充（BO1=1-0, BO3=2-0...），计入局胜率与对手胜率（轮空对手视为 0 胜率虚拟对手）</li>
              </ul>
            </div>
        ...
        <section className="mb-10">
          ...
          <div className="space-y-4">
            ...
            <FAQItem
              ...
              answer="瑞士轮中，当赛程进入后半段（R4、R5、R6），选手交手历史增多，可能出现「不重复对阵」与「战绩严格分层」两个硬约束冲突的情况——某些选手找不到合法对手。此时按规则7，下移组剩余者直接轮空（最终残余的下移组会先优先内部互相匹配，仍无法匹配的才轮空）。轮空人数始终为偶数（0、2、4 个），且轮空场次按赛制自动填充比分（BO1=1-0, BO3=2-0...），计入局胜率与对手胜率（轮空对手视为 0 胜率虚拟对手），统计公平性有保障。这是规则设计的正常行为，不是 bug。"
            />
            <FAQItem
