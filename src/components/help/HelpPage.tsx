...
const content: Record<AppLanguage, HelpCopy> = {
  zh: {
    ...
    featureItems: [
      ...
      { icon: <Keyboard className="w-5 h-5" />, title: '快速录分', description: '支持多小组同屏、搜索、筛选、任意顺序录分，并在颜色反馈后跳转下一场。' },
  ...
  en: {
    ...
    featureItems: [
      ...
      { icon: <Keyboard className="w-5 h-5" />, title: 'Quick score entry', description: 'View multiple groups together, search, filter, and advance after clear color feedback.' },
